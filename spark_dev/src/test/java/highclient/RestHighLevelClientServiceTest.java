...
import dave.elasticsearch.common.service.RestHighLevelClientService;
import dave.elasticsearch.common.util.SnowflakeIdWorker;
...
//@ComponentScan("dave.elasticsearch")
...
//    @Test
    public void search() throws IOException{
        SearchResponse response = service.search("name", /*"鸿星尔克"*/"毛衣", 0, 30, "idx_cloth");
...
//    @Test
    public void termSearch() throws IOException{
        SearchResponse response = service.termSearch("name", "鸿星尔克"/*"nike潮流毛衣"*/, 0, 50);
...
//        String  sourceCloths = JSON.toJSONString(list);
//        BulkResponse bulk = service.importAll("idx_cloth", true, cloths.toString()/*sourceCloths*//*cloths*/);
        BulkResponse bulk = service.importAll("idx_cloth", true, clothes/*sourceCloths*//*cloths*/);
