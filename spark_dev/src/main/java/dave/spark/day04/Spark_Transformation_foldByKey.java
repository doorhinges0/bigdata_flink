...
public class Spark_Transformation_foldByKey {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<SensorReading> list = SensorSourceFixedGenetator.getSRListWithSamekey(5, 2);
//        List<Tuple2<String, Double>> list = SensorSourceFixedGenetator.getSRPair(4);
        ...
        javaPairRDD.foldByKey(0.0,
            ...
            public void accept(Tuple2<String, Double> stringDoubleTuple2) {
                System.out.println("aggregateByKey =" + stringDoubleTuple2);
            }
        });

        // 根据每个分区内(相同key的在一个分区)最大的可以value,求和
        javaPairRDD.aggregateByKey(0.0,
                new Function2<Double, Double, Double>() {
                    @Override
                    public Double call(Double v1, Double v2) throws Exception {
                        if ( v1 > v2)
            ...
            @Override
            public void accept(Tuple2<String, Double> stringDoubleTuple2) {
                System.out.println("aggregateByKey max =" + stringDoubleTuple2);
            }
        });
