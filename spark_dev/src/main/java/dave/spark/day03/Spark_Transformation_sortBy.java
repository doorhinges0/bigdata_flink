...
public class Spark_Transformation_sortBy {
...
//        List<String> strList = Arrays.asList("hello world spark scala", "2", "dave", "we");
        ...
        rdd.sortBy(new Function<Integer, Integer>() {
            private static final long serialVersionUID = -9100392940616899180L;

            @Override
            public Integer call(Integer v1) throws Exception {
                return v1;
            }
        }, false , 3).mapPartitionsWithIndex(new Function2<Integer, Iterator<Integer>, Iterator<Integer>>() {
