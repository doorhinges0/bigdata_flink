...
public class TxMatchDetect {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<OrderEvent> orderds = env.readTextFile("E:\\flink_dev\\flink0001\\src\\main\\resources\\OrderLog.csv")
        ...
        DataStream<ReceiptEvent> receiptds = env.readTextFile("E:\\flink_dev\\flink0001\\src\\main\\resources\\ReceiptLog.csv")
        ...
        SingleOutputStreamOperator<Tuple2<OrderEvent, ReceiptEvent>> singleOutputStreamOperator = orderds.connect(receiptds)
                .process(new TxPayMatch());

        singleOutputStreamOperator.print("match=");
        singleOutputStreamOperator.getSideOutput(outputTagUnmatchPay).print("outputTagUnmatchPay");
        singleOutputStreamOperator.getSideOutput(outputTagUnmatchRecipt).print("outputTagUnmatchRecipt");
        env.execute();
    }
